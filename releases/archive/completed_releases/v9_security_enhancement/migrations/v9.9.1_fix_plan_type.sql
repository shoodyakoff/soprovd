-- Миграция v9.9.1: Исправление типа plan_type в increment_user_letters
-- Дата: 2024-12-19
-- Цель: Исправить ошибку "column reference plan_type is ambiguous"

-- Сначала удаляем старую функцию
DROP FUNCTION IF EXISTS increment_user_letters(BIGINT);

-- Создаем функцию с правильным типом возвращаемого значения
