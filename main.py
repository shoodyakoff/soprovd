"""
Главный файл Telegram-бота LetterGenius v4.0
...
def main():
    ...
    async def help_handler(update, context):
        await update.message.reply_text(
            "📋 <b>LetterGenius v4.0 - Умный генератор писем</b>\n\n"
    ...
    logger.info("🚀 Бот LetterGenius v4.0 запущен! Простой поток: вакансия → резюме → письмо")
